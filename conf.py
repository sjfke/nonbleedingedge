...
copyright = '2026, Geoffrey Collis'
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', '.venv', 'venv', 'venv-3.12', 'utilities', 'nginx']
...
latex_documents = [
    (master_doc, 'nonBleedingEdge.tex', 'nonBleedingEdge Documentation',
